...
public class CodeSafetyChecker {
    ...
    public static boolean isCodeSafe(CodeDTO codeDTO) {
        return !containsMaliciousPatterns(codeDTO) && !containsUnsafeFunctions(codeDTO);
    }

    private static boolean containsMaliciousPatterns(CodeDTO codeDTO) {
        String codeString = codeDTO.getCode();
    ...
    private static boolean containsUnsafeFunctions(CodeDTO codeDTO) {
        String codeString = codeDTO.getCode();
